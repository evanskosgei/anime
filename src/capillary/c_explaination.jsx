                ...
                <div className="px-6 py-4 border-b border-gray-700">
                    <div className='flex items-center justify-between'>
                        ...
                        <h1 className="text-2xl font-bold text-center text-blue-400">
                            {t('CapillaryTubeExplanation')}
                        </h1>
                    </div>
                </div>
                <div className="p-6">
                    <p className='text-2xl font-semibold text-blue-400'>{t('whatIsACapillaryTube')}</p>
                    <p>{t('capillaryTubeDescription')}</p>
                    ...
                    <ol className="space-y-4 list-decimal pl-6 mb-6">
                        <li>
                            <span className="font-bold">{t('narrowDiameter')}</span>
                            {t('narrowDiameterDescription')}
                        </li>
                        <li>
                            <span className="font-bold">{t('capillaryAction')}</span>
                            {t('capillaryActionDescription')}
                        </li>
                        <li>
                            <span className="font-bold">{t('precision')}</span>
