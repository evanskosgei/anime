    ...
    <>
      <div className="bg-gradient-to-br from-gray-900 to-gray-800 min-h-screen p-4 sm:p-8 text-white">
        ...
        <div className="group fixed bottom-10 right-10 p-2  flex items-end justify-end w-24 h-24 ">
          ...
          <div className="absolute rounded-full transition-all duration-[0.2s] ease-out scale-y-0 group-hover:scale-y-100 group-hover:-translate-x-16 flex hover:p-3 scale-100 hover:bg-red-100 text-white">
          <img width="40" height="40" src="https://img.icons8.com/color/48/china-circular.png" alt="china-circular"/>
          </div>
          <div className="absolute rounded-full transition-all duration-[0.2s] ease-out scale-x-0 group-hover:scale-x-100 group-hover:-translate-y-16  flex hover:p-3 hover:bg-yellow-400  text-white">
          <img width="40" height="40" src="https://img.icons8.com/color/48/india-circular.png" alt="india-circular"/>
          </div>
          <div className="absolute rounded-full transition-all duration-[0.2s] ease-out scale-x-0 group-hover:scale-x-100 group-hover:-translate-y-14 group-hover:-translate-x-14 flex hover:p-3 hover:bg-gray-50 text-white">
          <img width="40" height="40" src="https://img.icons8.com/color/48/great-britain-circular.png" alt="great-britain-circular"/>
          </div>
        </div>
      </div>
    </>
