...
// import ctd_1 from "../assets/ctd_labels/ctd1.jpeg"
import ctd_2 from "../assets/ctd_labels/ctd2.jpeg"
import Zoom_img from '../components/zoom';

const CTD_label_img = () => {
    const [openZoom, setOpenZoom] = useState(false);
    const [currentMedia, setCurrentMedia] = useState(null);
    const image = { src: ctd_2, alt: "Silica Plate Preparation", type: "image" };
